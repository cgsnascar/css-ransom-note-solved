...
- [x] Group selectors with the same styles.
  ...
  You can group the letter selectors by the common styles: [x]
  ...
  You can also add classes to target a group of HTML elements to apply the same set of styles: [x]
